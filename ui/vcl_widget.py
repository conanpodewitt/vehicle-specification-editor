...
class VCLEditor(QMainWindow):
    ...
    def show_ui(self):
        ...
        main_widget.addTab(input_tab, "Input")
        main_widget.addTab(output_tab, "Output")
        ...
        self.highlighter = CodeSyntaxHighlight(self.editor.document(), "external", "vse-style")    # Added syntax highlighting
